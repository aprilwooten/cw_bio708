...
v_abc100 <- c(20 "a" , 30 "b" , 50 "c" (length = 100))
...
mu_x_plus <- select(v_x, rnorm(100) > 0)
mean(mu_x_plus)
...
x <- factor(df_mtcars, cyl)
mutate(df_mtcars, f_cyl = x)
